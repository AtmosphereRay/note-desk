...
import { routes } from "@renderer/route/routes";
import { RouteType } from "@renderer/route/type";
import { useNavigate, useLocation } from "react-router-dom";
import { useDispatch } from "react-redux";
import type { AppDispatch, MenuListItem } from "@renderer/store";
import { useCommonStore } from "@renderer/hooks/useCommonStore";
import { setMenuList } from "@renderer/store/menu";
import { changeActive } from "@renderer/store/Tab";

import logo from "@renderer/assets/react.svg";
import "./menu.less";
